local light_table = {
    ...
    Headlight_sprites = {
        {
            pos = Vector(-23, 106, 30.23),
            size = 60,
            color = Color(220, 220, 220, 50)
        },
        {
            pos = Vector(-30, 106, 30.36),
            size = 60,
            color = Color(220, 220, 220, 50)
        },
        {
    ...
    Rearlight_sprites = {
        {
            pos = Vector(-35.5, -109.63, 40.75),
            material = "sprites/light_ignorez",
            size = 30,
            color = Color(255, 0, 0, 50)
        },
        {
            pos = Vector(-35.5, -109.63, 38),
            material = "sprites/light_ignorez",
            size = 30,
            color = Color(255, 0, 0, 50)
        },
        {
            pos = Vector(-24.5, -109.63, 40.75),
            material = "sprites/light_ignorez",
            size = 30,
            color = Color(255, 0, 0, 50)
        },
        {
            pos = Vector(-24.5, -109.63, 38),
            material = "sprites/light_ignorez",
            size = 30,
            color = Color(255, 0, 0, 50)
        },
    ...
    RearMarker_sprites = {Vector(-42.87, -101.7, 35.71), Vector(42.87, -101.7, 35.71)},
    --[[
	FogLight_sprites = {
    ...
    Turnsignal_sprites = {
        Left = {
            ...
            {
                pos = Vector(-26.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-27.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-28.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-29.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-30.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-31.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
            {
                pos = Vector(-32.06, 109.39, 15.74),
                material = "sprites/light_ignorez",
                size = 20
            },
        },
    ...
    ems_sprites = {
        {
            ...
            size = 60,
            Colors = {Color(0, 0, 250, 250), Color(0, 0, 255, 255), Color(0, 0, 250, 250), Color(0, 0, 200, 200), Color(0, 0, 150, 150), Color(0, 0, 100, 100), Color(0, 0, 50, 50), Color(0, 0, 0, 0)},
            Speed = 0.05,
        }
    },
    SubMaterials = {
...
local light_table = {
    ...
    Rearlight_sprites = {Vector(33.5, -120, 36), Vector(31.9, -120, 36), Vector(30.3, -120, 36), Vector(28.7, -120, 36), Vector(27.1, -120, 36), Vector(25.5, -120, 36), Vector(23.9, -120, 36), Vector(22.3, -120, 36), Vector(20.7, -120, 36), Vector(19.1, -120, 36), Vector(17.5, -120, 36), Vector(15.9, -120, 36), Vector(14.3, -120, 36), Vector(12.7, -120, 36), Vector(11.1, -120, 36), Vector(9.5, -120, 36), Vector(7.9, -120, 36), Vector(-33.5, -120, 36), Vector(-31.9, -120, 36), Vector(-30.3, -120, 36), Vector(-28.7, -120, 36), Vector(-27.1, -120, 36), Vector(-25.5, -120, 36), Vector(-23.9, -120, 36), Vector(-22.3, -120, 36), Vector(-20.7, -120, 36), Vector(-19.1, -120, 36), Vector(-17.5, -120, 36), Vector(-15.9, -120, 36), Vector(-14.3, -120, 36), Vector(-12.7, -120, 36), Vector(-11.1, -120, 36), Vector(-9.5, -120, 36), Vector(-7.9, -120, 36)},
    Reverselight_sprites = {Vector(-17.6, -121.1, 23.1), Vector(17.6, -121.1, 23.1)},
    FrontMarker_sprites = {Vector(-30, 120.5, 18), Vector(30, 120.5, 18), Vector(-42.5, 110.3, 24.4), Vector(42.5, 110.3, 24.4)},
    RearMarker_sprites = {Vector(-41.5, -113, 28), Vector(41.5, -113, 28)},
    Turnsignal_sprites = {
        Left = {Vector(-30, 120.5, 18), Vector(-42.5, 110.3, 24.4),},
        Right = {Vector(30, 120.5, 18), Vector(42.5, 110.3, 24.4)},
        TurnBrakeLeft = {Vector(-33.5, -120, 36), Vector(-31.9, -120, 36), Vector(-30.3, -120, 36), Vector(-28.7, -120, 36), Vector(-27.1, -120, 36), Vector(-25.5, -120, 36), Vector(-23.9, -120, 36), Vector(-22.3, -120, 36), Vector(-20.7, -120, 36), Vector(-19.1, -120, 36), Vector(-17.5, -120, 36), Vector(-15.9, -120, 36),},
        TurnBrakeRight = {Vector(33.5, -120, 36), Vector(31.9, -120, 36), Vector(30.3, -120, 36), Vector(28.7, -120, 36), Vector(27.1, -120, 36), Vector(25.5, -120, 36), Vector(23.9, -120, 36), Vector(22.3, -120, 36), Vector(20.7, -120, 36), Vector(19.1, -120, 36), Vector(17.5, -120, 36), Vector(15.9, -120, 36),},
    },
    DelayOn = 2.1,
    DelayOff = 2.1,
    Animation = {
...
local light_table = {
    ...
    Headlight_sprites = {
        {
            pos = Vector(84.2, 29.4, 22.3),
            material = "sprites/light_ignorez",
            size = 18,
            color = Color(215, 240, 255, 255)
        },
        {
            pos = Vector(84.2, 29.4, 22.3),
            size = 64,
            color = Color(215, 240, 255, 50)
        },
        {
            pos = Vector(84.2, -29.4, 22.3),
            material = "sprites/light_ignorez",
    ...
    Rearlight_sprites = {Vector(-88, 22.2, 31.2), Vector(-86.2, 26.9, 30.9), Vector(-88, -22.2, 31.2), Vector(-86.2, -26.9, 30.9)},
    Brakelight_sprites = {Vector(-88, 22.2, 31.2), Vector(-86.2, 26.9, 30.9), Vector(-88, -22.2, 31.2), Vector(-86.2, -26.9, 30.9), Vector(-70, 5.9, 49.8), Vector(-70, 4.425, 49.85), Vector(-70, 2.95, 49.9), Vector(-70, 1.475, 49.95), Vector(-70, 0, 50), Vector(-70, -5.9, 49.8), Vector(-70, -4.425, 49.85), Vector(-70, -2.95, 49.9), Vector(-70, -1.475, 49.95),},
    Reverselight_sprites = {Vector(-90, 16.6, 30.9), Vector(-90, -16.6, 30.9)},
    FogLight_sprites = {
        {
            pos = Vector(87.79, 26.65, 9.62),
            material = "sprites/light_ignorez",
            size = 16,
            color = Color(215, 240, 255, 255)
        },
...
local light_table = {
    ...
    L_RearLampAng = Angle(40, -90, 0),
    Headlight_sprites = {Vector(-12.25, 67.23, 22.33), Vector(-3.91, 67.03, 22.14), Vector(4.63, 66.33, 21.96), Vector(13.4, 66.72, 22.16)},
    Headlamp_sprites = {Vector(14.3, -59.87, 70.12), Vector(7.34, -58.62, 70.32), Vector(-7.79, -58.55, 70.09), Vector(-14.97, -60.01, 69.99)},
    Rearlight_sprites = {Vector(-14.9, -99.9, 39.13)},
    Brakelight_sprites = {Vector(-14.9, -99.9, 39.1)},
}
...
if file.Exists("models/vehicles/cars/69charger.mdl", "GAME") then list.Set("simfphys_vehicles", "sim_fphys_charger", V) end
local V = {
...
if file.Exists("models/vehicles/madmax/interceptordrive.mdl", "GAME") then list.Set("simfphys_vehicles", "sim_fphys_interceptor", V) end
local V = {
...
if file.Exists("models/red_hd_brera/red_hd_brera.mdl", "GAME") then list.Set("simfphys_vehicles", "sim_fphys_alfons", V) end
local V = {
    Name = "GTA 5 Dukes",
