...
local light_table = {
    ...
    Headlight_sprites = {Vector(118.8, 30.5, 41.8), Vector(118.8, -35, 41.8)},
    Headlamp_sprites = {Vector(118.8, 30.5, 41.8), Vector(118.8, -35, 41.8)},
    Turnsignal_sprites = {
        Left = {Vector(116.88, 36.33, 53.57), Vector(115.4, 37.9, 53.59), Vector(113.67, 39.87, 53.72), Vector(-100.76, 20.37, 18.99), Vector(-100.71, 18.55, 18.97), Vector(-100.71, 16.69, 19.1),},
        Right = {Vector(114.88, -40.33, 53.57), Vector(113.4, -41.9, 53.59), Vector(111.67, -43.87, 53.72), Vector(-100.76, -22.37, 18.99), Vector(-100.71, -20.55, 18.97), Vector(-100.71, -18.69, 19.1),},
    }
}
...
local light_table = {
    ...
    Rearlight_sprites = {Vector(43.04, -194, 21.05), Vector(43.03, -194, 22.49), Vector(43.23, -194, 23.34), Vector(43.14, -194, 24.32), Vector(-43.04, -194, 21.05), Vector(-43.03, -194, 22.49), Vector(-43.23, -194, 23.34), Vector(-43.14, -194, 24.32)},
    Brakelight_sprites = {Vector(43.04, -194, 21.05), Vector(43.03, -194, 22.49), Vector(43.23, -194, 23.34), Vector(43.14, -194, 24.32), Vector(-43.04, -194, 21.05), Vector(-43.03, -194, 22.49), Vector(-43.23, -194, 23.34), Vector(-43.14, -194, 24.32)},
    FrontMarker_sprites = {Vector(55.4, -156.48, 56.9), Vector(56.74, -70.56, 55.19), Vector(50, 73.98, 57.71), Vector(-53.4, -156.48, 56.9), Vector(-54, -70.56, 55.19), Vector(-50, 73.98, 57.71)},
    Turnsignal_sprites = {
        Left = {Vector(-38.2, 87.81, 58.93), Vector(-42.96, -193.67, 28.29),},
        Right = {Vector(37.8, 87.41, 58.52), Vector(43.38, -194.54, 28.99),},
    }
}
...
local light_table = {
    ...
    Headlight_sprites = {Vector(71.15, 23.26, 27.92), Vector(71.07, -23.15, 27.95)},
    Headlamp_sprites = {
        {
            pos = Vector(71.15, 23.26, 27.92),
            size = 80,
            color = Color(220, 205, 160, 50)
        },
        {
            pos = Vector(71.07, -23.15, 27.95),
            size = 80,
            color = Color(220, 205, 160, 50)
        },
    },
    Rearlight_sprites = {Vector(-72, 22, 29), Vector(-72, 23.5, 29), Vector(-72, 25, 29), Vector(-72, 26.5, 29), Vector(-72, 28, 29), Vector(-72, 29.5, 29), Vector(-72, 31, 29), Vector(-72, -22, 29), Vector(-72, -23.5, 29), Vector(-72, -25, 29), Vector(-72, -26.5, 29), Vector(-72, -28, 29), Vector(-72, -29.5, 29), Vector(-72, -31, 29),},
    Brakelight_sprites = {Vector(-72, 22, 29), Vector(-72, 23.5, 29), Vector(-72, 25, 29), Vector(-72, 26.5, 29), Vector(-72, 28, 29), Vector(-72, 29.5, 29), Vector(-72, 31, 29), Vector(-72, -22, 29), Vector(-72, -23.5, 29), Vector(-72, -25, 29), Vector(-72, -26.5, 29), Vector(-72, -28, 29), Vector(-72, -29.5, 29), Vector(-72, -31, 29),},
    Turnsignal_sprites = {
        Left = {Vector(-72.14, 29.97, 31.85), Vector(-72.14, 27.97, 31.85), Vector(-72.14, 25.97, 31.85), Vector(72.19, 24.97, 20.34),},
        Right = {Vector(-72.54, -30.32, 31.81), Vector(-72.54, -28.32, 31.81), Vector(-72.54, -26.32, 31.81), Vector(72.19, -24.6, 20.34),},
    },
}
...
local light_table = {
    ...
    Rearlight_sprites = {Vector(-47, -133.97, 28.14), Vector(44.13, -134.42, 27.34),},
    Reverselight_sprites = {Vector(32.33, -134.11, 27.34),},
    Turnsignal_sprites = {
        Left = {Vector(-39.88, 119.03, 66.5),},
        Right = {Vector(36.11, 119.71, 66.5),},
        TurnBrakeLeft = {Vector(-47, -133.97, 28.14),},
        TurnBrakeRight = {Vector(44.13, -134.42, 27.34),},
    },
}
...
local light_table = {
    ...
    Headlight_sprites = {
        {
            pos = Vector(75.7, 28.09, 31.28),
            material = "sprites/light_ignorez",
            size = 32,
            color = Color(220, 205, 160, 255)
        },
        {
            pos = Vector(75.7, 28.09, 31.28),
            size = 64,
    ...
    Rearlight_sprites = {Vector(-99.8, 21.57, 29.93), Vector(-99.86, 23.01, 29.9), Vector(-99.75, 24.52, 29.92), Vector(-99.8, -21.57, 29.93), Vector(-99.86, -23.01, 29.9), Vector(-99.75, -24.52, 29.92),},
    Brakelight_sprites = {Vector(-99.8, 21.57, 29.93), Vector(-99.86, 23.01, 29.9), Vector(-99.75, 24.52, 29.92), Vector(-99.8, -21.57, 29.93), Vector(-99.86, -23.01, 29.9), Vector(-99.75, -24.52, 29.92),},
    Reverselight_sprites = {Vector(-99.98, 27.41, 30.76), Vector(-99.98, -27.41, 30.76)},
    Turnsignal_sprites = {
        Left = {Vector(80.52, 25.03, 20.21), Vector(80.47, 23.03, 20.25), Vector(-100.5, 18.95, 29.97),},
        Right = {Vector(80.52, -25.03, 20.21), Vector(80.47, -23.03, 20.25), Vector(-100.5, -18.95, 29.97),},
    },
}
...
local light_table = {
    ...
    Headlight_sprites = {Vector(-28.77, 70.69, 30.73), Vector(29.13, 70.77, 30.58)},
    Headlamp_sprites = {
        {
            pos = Vector(-28.77, 70.69, 30.73),
            size = 80,
            color = Color(220, 205, 160, 50)
        },
        {
            pos = Vector(29.13, 70.77, 30.58),
            size = 80,
            color = Color(220, 205, 160, 50)
        },
    },
    Rearlight_sprites = {Vector(30.83, -78.44, 24.), Vector(30.83, -78.44, 25), Vector(30.83, -78.44, 26), Vector(-30.83, -78.50, 24), Vector(-30.83, -78.50, 25), Vector(-30.83, -78.50, 26)},
    Brakelight_sprites = {Vector(30.83, -78.44, 24.), Vector(30.83, -78.44, 25), Vector(30.83, -78.44, 26), Vector(-30.83, -78.50, 24), Vector(-30.83, -78.50, 25), Vector(-30.83, -78.50, 26)},
    Reverselight_sprites = {Vector(30.77, -76.39, 20.09), Vector(-31.01, -76.14, 20.29),},
    Turnsignal_sprites = {
        Left = {Vector(-28.5, 70.97, 20.41), Vector(-30, 70.97, 20.41), Vector(-31.5, 70.97, 20.41), Vector(-30.63, -79, 34), Vector(-30.63, -79., 32), Vector(-30.63, -79, 30), Vector(-30.63, -79, 28),},
        Right = {Vector(28.5, 70.97, 20.41), Vector(30, 70.97, 20.41), Vector(31.5, 70.97, 20.41), Vector(30.63, -79, 34), Vector(30.63, -79., 32), Vector(30.63, -79, 30), Vector(30.63, -79, 28),},
    }
}
...
local light_table = {
    ...
    R_RearLampAng = Angle(45, 180, 0),
    Headlight_sprites = {Vector(97.41, 33.55, 37.05), Vector(97.45, 36.17, 37.08), Vector(97.61, 38.86, 37.14), Vector(97.25, -33.56, 37.04), Vector(97.23, -36.19, 37.03), Vector(97.13, -38.64, 37.08)},
    Headlamp_sprites = {Vector(97.45, 36.17, 37.08), Vector(97.23, -36.19, 37.03)},
    Rearlight_sprites = {
        {
            pos = Vector(-117, -32.5, 41),
            material = "sprites/light_ignorez",
            size = 35,
    ...
    Reverselight_sprites = {Vector(-117, -32.5, 45), Vector(-117, -34.5, 45), Vector(-117, -30.5, 45), Vector(-117, 32.5, 45), Vector(-117, 34.5, 45), Vector(-117, 30.5, 45)},
    Turnsignal_sprites = {
        Left = {Vector(96.64, 36.27, 27.21), Vector(96.64, 35, 27.21),},
        Right = {Vector(96.64, -36.27, 27.21), Vector(96.64, -35, 27.21),},
        TurnBrakeLeft = {
            {
                pos = Vector(-117, 32.5, 41),
                material = "sprites/light_ignorez",
...
local light_table = {
    ...
    R_RearLampAng = Angle(45, 180, 0),
    Headlight_sprites = {Vector(91.33, 30.44, 30.63), Vector(91.33, -30.44, 30.63)},
    Headlamp_sprites = {Vector(91.33, 30.44, 30.63), Vector(91.33, -30.44, 30.63)},
    Rearlight_sprites = {
        {
            pos = Vector(-102.23, 30, 35.85),
            material = "sprites/light_ignorez",
            size = 35,
            color = Color(255, 60, 0, 125)
        },
    ...
    Reverselight_sprites = {Vector(-101.8, -29.4, 30.7), Vector(-101.8, -31.09, 30.7), Vector(-101.8, 29.4, 30.7), Vector(-101.8, 31.09, 30.7),},
    Turnsignal_sprites = {
        Left = {Vector(-102.62, 31, 33.24), Vector(-102.62, 29, 33.24), Vector(92.09, 31, 22.4), Vector(91.71, 33, 22.4),},
        Right = {Vector(-102.62, -31, 33.24), Vector(-102.62, -29, 33.24), Vector(92.09, -31, 22.4), Vector(91.71, -33, 22.4),},
    },
}
...
local light_table = {
    ...
    R_RearLampAng = Angle(45, 180, 0),
    Headlight_sprites = {Vector(87.3, 29.59, 35.42), Vector(87.34, -31.76, 35.52)},
    Headlamp_sprites = {Vector(87.3, 29.59, 35.42), Vector(87.34, -31.76, 35.52)},
    Rearlight_sprites = {Vector(-95.5, 21, 34), Vector(-95.5, 21, 33), Vector(-95.5, 21, 32), Vector(-95.5, 22.25, 34), Vector(-95.5, 22.25, 32), Vector(-95.5, 23.5, 34), Vector(-95.5, 23.5, 33), Vector(-95.5, 23.5, 32), Vector(-95.5, -23.5, 34), Vector(-95.5, -23.5, 33), Vector(-95.5, -23.5, 32), Vector(-95.5, -24.75, 34), Vector(-95.5, -24.75, 32), Vector(-95.5, -26, 34), Vector(-95.5, -26, 33), Vector(-95.5, -26, 32)},
    Brakelight_sprites = {Vector(-95.5, 15.5, 34.8), Vector(-95.5, 15.5, 33.4), Vector(-95.5, 15.5, 32.6), Vector(-95.5, 15.5, 31.2), Vector(-95.5, -18, 34.8), Vector(-95.5, -18, 33.4), Vector(-95.5, -18, 32.6), Vector(-95.5, -18, 31.2)},
    Reverselight_sprites = {Vector(-95.5, 18.25, 34.8), Vector(-95.5, 18.25, 33.4), Vector(-95.5, 18.25, 32.6), Vector(-95.5, 18.25, 31.2), Vector(-95.5, -20.75, 34.8), Vector(-95.5, -20.75, 33.4), Vector(-95.5, -20.75, 32.6), Vector(-95.5, -20.75, 31.2)},
    Turnsignal_sprites = {
        Left = {Vector(86.78, 22.39, 31.92), Vector(-95.41, 26.7, 33.76), Vector(-95.42, 26.72, 32.22),},
        Right = {Vector(86.78, -24.39, 31.92), Vector(-95.41, -28.7, 33.76), Vector(-95.42, -28.72, 32.22),},
    },
}
